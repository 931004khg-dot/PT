(defun C:PT (/ dcl_id dcl_file result option custom_val ss ent obj_list obj thickness sub_option 
  ...
  ;; 액션 설정
  (action_tile "asp1" "(setq option \"asp1\")")
  (action_tile "asp2" "(setq option \"asp2\")")
  (action_tile "asp3" "(setq option \"asp3\")")
  (action_tile "asp_over" "(setq option \"asp_over\")")
  (action_tile "conc" "(setq option \"conc\")")
  (action_tile "sido1" "(setq option \"sido1\")")
  (action_tile "sido2" "(setq option \"sido2\")")
  (action_tile "bike" "(setq option \"bike\")")
  (action_tile "custom" "(setq option \"custom\")")
